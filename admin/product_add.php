        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div id="tab-fr" class="tab-pane-content">
                <div class="form-group">
                    ...
                    <input type="text" name="product_name_fr" class="form-control lg" required placeholder="Ex: Tomates Fraîches">
                </div>
                <div class="form-group">
                    <label>Description (FR)</label>
                    <textarea name="product_description_fr" class="form-control" rows="4" style="height: auto;"></textarea>
                </div>
            </div>
            ...
            <div id="tab-ar" class="tab-pane-content" style="display: none;" dir="rtl">
                <div class="form-group">
                    ...
                    <input type="text" name="product_name_ar" class="form-control lg" required placeholder="مثال: طماطم طازجة">
                </div>
                <div class="form-group">
                    <label>الوصف (AR)</label>
                    <textarea name="product_description_ar" class="form-control" rows="4" style="height: auto;"></textarea>
                </div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 30px; margin-top: 40px; padding-top: 40px; border-top: 2px solid var(--gray-bg);">
                ...
                <div class="form-group">
                    ...
                    <div style="position: relative;">
                        <input type="number" name="product_price" class="form-control" step="0.01" required min="0" style="padding-right: 50px;">
                ...
                <div class="form-group">
                    ...
                    <div style="position: relative;">
                        <input type="number" name="product_sale_price" class="form-control" step="0.01" min="0" style="padding-right: 50px;">
                ...
                <div class="form-group" style="grid-column: span 3; display: flex; gap: 40px; align-items: center; background: var(--gray-bg); padding: 25px; border-radius: 16px; margin-top: 10px;">
                    <label class="check-label">
                        <input type="checkbox" name="product_is_on_sale" value="1"> 
                        <span>Activer badge Promo</span>
                    </label>
                    <label class="check-label">
                        <input type="checkbox" name="product_is_featured" value="1"> 
            ...
            <div style="margin-top: 40px; text-align: right;">
                <button type="submit" class="btn btn-orange" style="padding: 18px 60px; font-size: 16px;">
                    <i data-lucide="save" size="22"></i> Enregistrer le Produit
                </button>
            </div>
