...
function add_product(array $product_data, array $image_file): array
{
    ...
    try {
        execute_query($sql, [
            ...
            ':name_fr'   => sanitize_input($product_data['product_name_fr']),
            ':name_ar'   => sanitize_input($product_data['product_name_ar']),
            ':slug'      => $slug,
            ':desc_fr'   => sanitize_input($product_data['product_description_fr'] ?? ''),
            ':desc_ar'   => sanitize_input($product_data['product_description_ar'] ?? ''),
